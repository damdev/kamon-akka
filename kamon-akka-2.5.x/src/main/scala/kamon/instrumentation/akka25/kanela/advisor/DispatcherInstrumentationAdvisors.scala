...
package akka.kamon.instrumentation.akka25.kanela.advisor
...
import akka.kamon.instrumentation.akka25.kanela.advisor.DispatcherInstrumentationAdvisors.{extractExecutor, registerDispatcher, registeredDispatchers}
