...
import akka.kamon.instrumentation.akka25.kanela.interceptor.{InvokeAllMethodInterceptor, ReplaceWithMethodInterceptor}
import kamon.instrumentation.akka25.kanela.mixin.ActorInstrumentationMixin
